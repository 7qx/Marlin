...
//#define LCD_SHOW_E_TOTAL
   ...
   */
  #define SDCARD_CONNECTION LCD_AND_ONBOARD //_AND_ONBOARD
...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
    ...
    #define LONGCLICK_FOR_IDLE              // instead of BABYSTEP_ALWAYS_AVAILABLE https://github.com/ursoft/Marlin/issues/6
...
#define PHOTO_GCODE
  ...
  #define PHOTO_POSITION { X_MAX_POS - 5, Y_MAX_POS - 5, 0 }  // { xpos, ypos, zraise } (M240 X Y Z)
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Unmount media"
  #define USER_GCODE_1 "M22"

  #define USER_DESC_2 "Filament change"
  #define USER_GCODE_2 "M600"
...
#define HOST_ACTION_COMMANDS
  ...
  #define HOST_PROMPT_REINIT_DISPLAY
#endif
